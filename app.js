const DATA = {
  hotels: [
    ...
    },
    {
      ...
      text: "D5到大连后直接东港晚餐、夜景和可选洗浴；D6从早市切到星海、莲花山、老虎滩，再把中山广场/俄罗斯风情街等市区点位前移；D7 11:40 厦航返福州，早上只留退房和去机场。",
  ...
  days: [
    ...
    },
    {
      ...
      date: "7月9日",
      title: "烟台山到养马岛",
      summary: "酒店 → 8鲜蓬莱小面 → 烟台山 → 滨海广场 → 月亮湾 → 东炮台 → 渔人码头 → 养马岛 → 篱笆巷子火锅 → 酒店",
      routeNote: "从老城沿滨海中路一路向东，养马岛放最后，晚餐回市区吃篱笆巷子火锅。",
      stops: [
        ...
        ["19:00", "篱笆巷子火锅", "烟台 篱笆巷子火锅", "晚餐吃火锅；如果养马岛返程太晚，再改附近鲁菜海鲜。", 62, 78, "driving"],
      ],
    },
    {
      id: "day5",
      date: "7月10日",
      title: "烟台轮渡到大连",
      summary: "烟台酒店 → 烟台港客运站 → 上午轮渡去大连 → 大连港/大连湾新港 → 桔子酒店大连东港港湾广场店 → 威尔威尔海胆披萨 → 中山广场 → 大连美术馆/俄罗斯风情街 → 东港夜景 → 可选洗浴",
      routeNote: "轮渡日船程约7小时，到大连后以东港晚餐、夜景和轻量市区打卡为主，洗浴看体力决定。",
      stops: [
        ["08:20", "全季酒店 烟台火车站所城里店", "全季酒店 烟台火车站所城里店", "退房，早餐后按船班提前出发。", 12, 70, "driving", "烟台全季酒店"],
        ["09:00", "烟台港客运站", "烟台港客运站", "提前确认码头、船名、安检和到港码头。", 28, 48, "driving"],
        ["10:00", "上午轮渡去大连", "烟台港客运站", "船程约7小时，船上自备水、简餐、晕船药和充电宝。", 46, 36, "driving", "烟台到大连轮渡"],
        ["17:00", "大连港/大连湾新港", "大连港客运站 大连湾新港", "到港后先打车去酒店办理入住。", 62, 52, "driving", "大连到港码头"],
        ["17:50", "桔子酒店 大连东港港湾广场店", "桔子酒店 大连东港港湾广场店", "入住东港片区，放行李后出门吃晚餐。", 76, 42, "driving", "大连桔子酒店"],
        ["18:40", "WHERE·WHERE 威尔·威尔美式西餐厅 东港店", "WHERE WHERE 威尔威尔美式西餐厅 东港店 大连 港浦路74号", "晚餐吃海胆披萨，地址在中山区港浦路74号。", 72, 72, "walking", "威尔威尔海胆披萨"],
        ["19:50", "中山广场", "大连 中山广场", "轻松拍建筑群，夜间只短停。", 84, 60, "driving"],
        ["20:25", "大连美术馆/俄罗斯风情街", "大连美术馆 俄罗斯风情街", "把返程日上午的市区点前移，顺路轻量打卡。", 64, 58, "walking", "大连美术馆"],
        ["21:05", "东方威尼斯水城/东港夜景", "大连 东方威尼斯水城 东港", "回东港看夜景，体力不足就直接回酒店。", 52, 82, "driving", "东港夜景"],
        ["21:40", "可选洗浴体验", "大连 大渔海棠 城市温泉生活馆 漫汤泉", "可选泡汤/汗蒸/休息；轮渡太累就取消。", 38, 72, "driving", "大连洗浴"],
      ],
    },
    {
      id: "day6",
      date: "7月11日",
      title: "大连星海到老虎滩",
      summary: "酒店 → 桃源市场早市 → 星海广场 → 跨海大桥观景点 → 莲花山南2门/莲花山观景台 → 傅家庄 → 菱角湾 → 老虎滩 → 青泥洼桥 → 东港/酒店",
      routeNote: "早上先吃桃源市场，再打车到星海；参考大连一日游笔记的莲花山南2门走法，主景点集中到这一天完成。",
      stops: [
        ["07:50", "桔子酒店 大连东港港湾广场店", "桔子酒店 大连东港港湾广场店", "从酒店出发去早市。", 12, 76, "driving", "大连桔子酒店"],
        ["08:20", "桃源市场早市", "大连 桃源市场", "早餐吃焖子、海菜包子、豆腐脑、油条、蛋堡。", 24, 62, "driving", "桃源市场"],
        ["09:30", "星海广场", "大连 星海广场", "上午到星海，开始南部海岸线。", 16, 68, "driving"],
        ["10:20", "星海湾跨海大桥最佳观景点", "大连 星海湾跨海大桥最佳观景点", "拍跨海大桥。", 30, 44, "driving", "跨海大桥观景点"],
        ["11:20", "莲花山南2门/莲花山观景台", "大连 莲花山南2门 莲花山观景台", "参考小红书一日游走法，看大连全景。", 42, 32, "driving", "莲花山南2门"],
        ["12:40", "旅大印象·大连家常海鲜馆 星海店", "旅大印象 大连家常海鲜馆 星海店", "午餐吃海肠捞饭、海胆石锅豆腐。", 52, 48, "driving", "旅大印象"],
        ["14:20", "傅家庄公园", "大连 傅家庄公园", "沿南部海岸线向东。", 62, 64, "driving"],
        ["15:30", "菱角湾", "大连 菱角湾", "拍渔人码头视角。", 72, 50, "driving"],
        ["16:20", "老虎滩海洋公园", "大连 老虎滩海洋公园", "可只作为海岸线节点，不一定入园。", 84, 38, "driving"],
        ["18:00", "品海楼 老虎滩店", "品海楼 老虎滩店 大连", "晚餐吃海肠捞饭、海胆锅贴、三鲜焖子；也可改正黄旗海鲜烧烤。", 78, 72, "walking"],
        ["19:40", "青泥洼桥", "大连 青泥洼桥", "市区收尾，体力不够就跳过直接回酒店。", 64, 82, "driving"],
      ],
    },
    {
      id: "day7",
      date: "7月12日",
      title: "11:40 厦航返福州，早上不塞行程",
      summary: "酒店 → 退房 → 大连周水子机场",
      routeNote: "最后一天不再安排景点，09:40 前到周水子机场，避免误机。",
      stops: [
        ["08:20", "桔子酒店 大连东港港湾广场店", "桔子酒店 大连东港港湾广场店", "酒店早餐、整理行李、退房。", 24, 70, "walking", "大连桔子酒店"],
        ["09:00", "前往大连周水子国际机场", "大连周水子国际机场", "从酒店打车去机场，预留市区路况时间。", 54, 52, "driving", "去周水子机场"],
        ["09:40", "大连周水子国际机场", "大连周水子国际机场", "建议 09:40 前到机场，办理值机和安检。", 82, 36, "driving"],
        ["11:40", "厦航返福州", "大连周水子国际机场", "11:40 厦航返福州，早上不再加景点。", 88, 72, "walking", "返程航班"],
      ],
    },
  ],
  foods: [
    ...
    ["烟台", "D4 滨海线", "早餐8鲜蓬莱小面；午餐万盛合渔人码头店；晚餐篱笆巷子火锅，养马岛返程太晚再改附近鲁菜海鲜。"],
    ["大连", "D5 东港夜景", "轮渡日午餐自备简餐；晚餐 WHERE·WHERE 威尔·威尔美式西餐厅东港店，主打海胆披萨；晚上可选洗浴。"],
    ["大连", "D6 海岸线", "早餐桃源市场早市；午餐旅大印象星海店；晚餐品海楼老虎滩店或正黄旗海鲜烧烤大排档。"],
    ["大连", "D7 返程前", "酒店早餐或机场简餐；11:40 厦航返福州，早上不再安排正餐和景点。"],
  ],
};
